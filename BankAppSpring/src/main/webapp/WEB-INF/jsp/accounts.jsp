...
<body onload="formatData()">
	...
	<table>
		...
		<c:forEach var="entry" items="${accountList}">
			<tr>
	...
	<form action="${pageContext.request.contextPath}/app/accounts"
	...
	<a href="${pageContext.request.contextPath}/app/clients"><button>Back</button></a>

	<script type="text/javascript"
		src="${pageContext.request.contextPath}/resources/js/accounts.js"></script>
</body>
</html>